...
- 当前中国历法结果通过 `standards/calendar-chinese/lunar.json` 进行离散样例校验。
- 当前 fixture 覆盖 2020 / 2023 / 2024 / 2025 的闰月、年界、月界与干支边界。
- 当前可对外说明的口径是“modern 规则集在这些边界样例上稳定可复核”，不是历史历书全量等价声明。
- 更完整的来源、覆盖范围和“当前不能说明什么”，统一参见 `standards/README.md#当前可对外说明的精度口径`。
